...
abstract class DB_driver {
	...
	public function load_rdriver()
	{
		...
		{
			require_once(SYSPATH.'database/DB_result.php');
			require_once(SYSPATH.'database/drivers/'.$this->dbdriver.'/'.$this->dbdriver.'_result.php');
		}
	...
	public function count_all($table = '')
	{
		...
		$query = $this->query($this->_count_string.$this->escape_identifiers('numrows').' FROM '.$table);
		if ($query->num_rows() === 0)
		{
			return 0;
		}
	...
	{
		$query = $this->query($this->_field_data($table));
